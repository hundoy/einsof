...
for(var dto_i=45; dto_i<405; dto_i+=360/8)
{
    ...
    draw_text_ext_transformed_colour(msgbox_x+text_margin_x+lengthdir_x(tol,dto_i), msgbox_y+text_margin_y+lengthdir_y(tol,dto_i), text, stringHeight, boxWidth, 1.333, 1.333, 0, c_black, c_black, c_black, c_black, 1);
}

draw_text_ext_transformed_colour(msgbox_x+text_margin_x, msgbox_y+text_margin_y, text, stringHeight, boxWidth, 1.333, 1.333, 0, c_white, c_white, c_white, c_white, 1);
